...
//
// ⚠ index.astro STILL CARRIES ITS OWN COPY, deliberately, until the homepage
// FAQ is reduced. Two copies of the same fourteen entries are free to drift in
// the meantime — the condition gate 5 exists for on the positioning line, and
// it wants the same treatment here. Until that gate exists, an edit to one of
// these entries is an edit to BOTH files.
//
